...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(e,t,n){let r=new Float32Array(Ya),i=new G(0,1,0);return new Ui({name:`SphericalGaussianBlur`,defines:{n:Ya,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new Ui({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Ui({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:po(),fragmentShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            linear-gradient(
              ...
              transparent 70%,
              rgba(255,255,255,.18)
            )`,backgroundOrigin:`border-box`,backgroundClip:`padding-box,border-box`,transformStyle:`preserve-3d`,transition:`transform 120ms cubic-bezier(0.22, 1, 0.36, 1), border-color 180ms ease-out, box-shadow 180ms ease-out`,boxShadow:i.active?`inset 0 1px rgba(255,255,255,.08), inset 0 -10px 25px rgba(0, 0, 0, 0.5), 0 25px 55px rgba(0, 0, 0, 0.45)`:`inset 0 1px rgba(255,255,255,.08), inset 0 -10px 25px rgba(0, 0, 0, 0.28), 0 12px 28px rgba(0, 0, 0, 0.3)`,...n},children:[(0,j.jsx)(`div`,{className:`pointer-events-none absolute inset-0 transition-opacity duration-300`,style:{opacity:+!!i.active,background:`radial-gradient(circle 120px at ${i.x}% ${i.y}%, rgba(255,255,255,0.12), transparent 70%)`}}),(0,j.jsx)(`div`,{className:`shine pointer-events-none absolute inset-0`,style:{zIndex:2}}),(0,j.jsxs)(`div`,{style:{transform:`translateZ(40px)`,transformStyle:`preserve-3d`},children:[(0,j.jsx)(`div`,{className:`mb-5 p-3 inline-flex transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-1`,style:{background:`rgba(201,162,39,0.08)`,border:`1px solid rgba(201,162,39,0.15)`,color:`var(--gold-400)`,boxShadow:i.active?`0 8px 16px rgba(201,162,39,0.06)`:`none`,transition:`transform 300ms, box-shadow 300ms`},children:e.icon}),(0,j.jsx)(`h3`,{className:`font-cinzel font-semibold text-lg mb-3`,style:{color:`#e8e8e8`},children:e.title}),(0,j.jsx)(`p`,{className:`text-sm leading-relaxed`,style:{color:`var(--steel-light)`,lineHeight:`1.7`},children:e.body})]}),(0,j.jsx)(`div`,{className:`pointer-events-none absolute bottom-0 left-0 right-0 h-px opacity-0 group-hover:opacity-100 transition-opacity duration-500`,style:{background:`linear-gradient(90deg, transparent, rgba(255,255,255,0.18), transparent)`}})]})})}function $c(){return(0,j.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-3 gap-6 mb-20`,children:[{title:`Progression First`,body:`We raid with purpose. Every pull is analyzed, every wipe a lesson. Our structured approach to mythic progression keeps us efficient and competitive.`,icon:(0,j.jsx)(E,{size:22}),delay:`0ms`},{title:`Tight Community`,body:`Beyond the raid team, Ride On Time is a home. We run keys together, theorycraft late into the night, and celebrate each other's victories.`,icon:(0,j.jsx)(T,{size:22}),delay:`200ms`},{title:`Long Legacy`,body:`Our raiders have multiple tiers of Cutting Edge achievements. A track record built on consistency, smart recruiting, and leadership that knows what it takes.`,icon:(0,j.jsx)(C,{size:22}),delay:`400ms`}].map((e,t)=>(0,j.jsx)(Qc,{item:e},t))})}function el({end:e,suffix:t=``,prefix:n=``,label:r,icon:i}){let[a,o]=(0,_.useState)(0),s=(0,_.useRef)(null),c=(0,_.useRef)(!1);return(0,_.useEffect)(()=>{let t=new IntersectionObserver(([t])=>{if(t.isIntersecting&&!c.current){c.current=!0;let t=0,n=r=>{t||=r;let i=Math.min((r-t)/800,1),a=1-(1-i)**3;o(Math.floor(a*e)),i<1?requestAnimationFrame(n):o(e)};requestAnimationFrame(n)}},{threshold:.5});return s.current&&t.observe(s.current),()=>t.disconnect()},[e]),(0,j.jsxs)(`div`,{ref:s,className:`flex flex-col items-center gap-3 p-6 relative group`,children:[(0,j.jsx)(`div`,{className:`p-3 rounded-full mb-1 transition-all duration-300 group-hover:scale-110`,style:{background:`rgba(201,162,39,0.1)`,border:`1px solid rgba(201,162,39,0.2)`,color:`var(--gold-400)`},children:i}),(0,j.jsxs)(`div`,{className:`font-cinzel font-bold text-3xl md:text-4xl text-gold-gradient`,children:[n,a,t]}),(0,j.jsx)(`div`,{className:`font-cinzel text-xs tracking-widest text-center`,style:{color:`var(--steel)`,letterSpacing:`0.15em`},children:r.toUpperCase()})]})}function tl(){let e=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.1});return e.current?.querySelectorAll(`.reveal`).forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(`section`,{id:`about`,ref:e,className:`relative py-32 overflow-hidden`,children:[(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none`,style:{background:`linear-gradient(180deg, #06080f 0%, #0a0e1a 50%, #06080f 100%)`}}),(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none opacity-30`,style:{backgroundImage:`radial-gradient(ellipse 40% 30% at 20% 50%, rgba(30,58,92,0.4) 0%, transparent 70%),
                            radial-gradient(ellipse 40% 30% at 80% 50%, rgba(201,162,39,0.08) 0%, transparent 70%)`}}),(0,j.jsxs)(`div`,{className:`w-full max-w-screen-2xl mx-auto px-8 sm:px-10 lg:px-12 relative z-10`,children:[(0,j.jsxs)(`div`,{className:`reveal flex flex-col items-center text-center mb-20`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest mb-4`,style:{color:`var(--gold-400)`,letterSpacing:`0.3em`},children:`OUR STORY`}),(0,j.jsx)(`h2`,{className:`font-cinzel font-bold text-gold-gradient mb-6`,style:{fontSize:`clamp(1.8rem, 4vw, 3rem)`},children:`The Guild`}),(0,j.jsx)(`div`,{className:`gold-separator`}),(0,j.jsxs)(`div`,{className:`mt-8 w-full leading-relaxed font-light`,style:{color:`var(--steel-light)`,lineHeight:`1.8`,fontSize:`1.2rem`},children:[`Welcome to Ride On Time, where we prove that "Cutting Edge" and "Clinical Depression" don't have to be synonyms.`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`We are a group of former CE and Mythic raiders with CE aspirations, who decided to build our own guild and community from the ground up, with a focus on building a long-lasting guild to try and find that that sweet spot of high performance and a super High ego Guild Leader To accomplish that, we prioritize respect for each other's time and efforts. Which means that raiders may be benched if they are not putting in the effort to improve their performance, learning from their mistakes, or failing to show up on time and ready to roll. It also means that we always remember that we are hitting virtual dragons for digital pants. It's not that serious.`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),(0,j.jsxs)(`div`,{className:`mt-3 space-y-2`,children:[`We offer a consistent core group of officers and players with decades of combined experience in raids, mythic plus, who are willing to help gear, review logs, discuss ways to improve, as well as just chill.`,(0,j.jsx)(`br`,{}),`Flasks, repairs, food, and other raid essentials are provided.`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`If this sounds appealing to you, hit us up on discord and join for a raid or a night of dungeons, and see if the vibes vibe.`]})]})]}),(0,j.jsx)($c,{}),(0,j.jsxs)(`div`,{className:`reveal grid grid-cols-2 md:grid-cols-3 gap-0 border border-yellow-400/10`,style:{background:`rgba(10,14,26,0.6)`},children:[(0,j.jsx)(el,{end:120,suffix:`+`,label:`Guild Members`,icon:(0,j.jsx)(D,{size:20})}),(0,j.jsx)(el,{end:2026,label:`Established`,icon:(0,j.jsx)(C,{size:20})}),(0,j.jsx)(el,{end:100,prefix:`Top `,label:`Realm`,icon:(0,j.jsx)(T,{size:20})})]})]})]})}var nl=[{name:`The Voidspire`,tier:`Midnight - Season 1`,image:`https://wow.zamimg.com/uploads/guide/header/37357f1e59c5b49de2c0dd9af4b11529888f67ce.jpg`,bosses:[`Imperator Averzian`,`Vorasius`,`Fallen-King Salhadaar`,`Vaelgor & Ezzorak`,`Lightblinded Vanguard`,`Crown of the Cosmos (Current Prog)`],progress:{Heroic:6,Mythic:5}},{name:`The Dreamrift`,tier:`Midnight - Season 1`,image:`https://wow.zamimg.com/uploads/screenshots/normal/1250125.png`,bosses:[`Chimaerus`],progress:{Heroic:1,Mythic:1}},{name:`March on Quel'Danas`,tier:`Midnight - Season 1`,image:`https://wow.zamimg.com/uploads/guide/header/fcfbc7d789bd78e9aa578cb8f3bf7d3c707ee39a.jpg`,bosses:[`Belo'ren, Child of Al'ar`,`L'ura, Midnight Falls`],progress:{Heroic:2,Mythic:0}},{name:`Sporefall`,tier:`Midnight - Season 1`,image:`https://wow.zamimg.com/uploads/screenshots/normal/1288541.jpg`,bosses:[`Rotmire`],progress:{Heroic:1,Mythic:1}}],rl={Heroic:{bar:`linear-gradient(90deg, #1a5a8a, #2a8acd)`,text:`#4aaae8`,badge:`rgba(26,90,138,0.2)`},Mythic:{bar:`linear-gradient(90deg, #7a2a8a, #c44acd)`,text:`#d46ae8`,badge:`rgba(122,42,138,0.2)`}};function il({killed:e,total:t,difficulty:n,animate:r}){let i=r?e/t*100:0,a=rl[n];return(0,j.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,j.jsx)(`div`,{className:`flex-1 h-1.5 progress-bar-track`,children:(0,j.jsx)(`div`,{className:`progress-bar-fill h-full`,style:{width:`${i}%`,background:a.bar,transition:r?`width 1s cubic-bezier(0.25, 0.46, 0.45, 0.94)`:`none`}})}),(0,j.jsxs)(`span`,{className:`font-cinzel text-xs tabular-nums`,style:{color:a.text,minWidth:`40px`},children:[e,`/`,t]})]})}function al(){let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)(`Mythic`),[i,a]=(0,_.useState)(!1),o=(0,_.useRef)(null);(0,_.useEffect)(()=>{let e=new IntersectionObserver(([e])=>{e.isIntersecting&&(a(!0),o.current?.querySelectorAll(`.reveal`).forEach(e=>e.classList.add(`visible`)))},{threshold:.2});return o.current&&e.observe(o.current),()=>e.disconnect()},[]);let s=n=>{n!==e&&(a(!1),t(n),setTimeout(()=>a(!0),50))},c=e=>{e!==n&&(a(!1),r(e),setTimeout(()=>a(!0),50))},l=nl[e],u=l.progress[n],d=l.bosses.length;return(0,j.jsxs)(`section`,{id:`progression`,ref:o,className:`relative py-32 overflow-hidden`,style:{background:`linear-gradient(180deg, #06080f 0%, #0d1420 50%, #06080f 100%)`},children:[(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none opacity-20`,style:{backgroundImage:`radial-gradient(ellipse 50% 40% at 50% 50%, rgba(201,162,39,0.08) 0%, transparent 70%)`}}),(0,j.jsxs)(`div`,{className:`w-full max-w-screen-2xl mx-auto px-8 sm:px-10 lg:px-12 relative z-10`,children:[(0,j.jsxs)(`div`,{className:`reveal flex flex-col items-center text-center mb-16`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest mb-4`,style:{color:`var(--gold-400)`,letterSpacing:`0.3em`},children:`RAID PROGRESSION`}),(0,j.jsx)(`h2`,{className:`font-cinzel font-bold text-gold-gradient mb-6`,style:{fontSize:`clamp(1.8rem, 4vw, 3rem)`},children:`Current Tier`}),(0,j.jsx)(`div`,{className:`gold-separator`})]}),(0,j.jsxs)(`div`,{className:`reveal border border-yellow-400/10`,style:{background:`rgba(10,14,26,0.7)`},children:[(0,j.jsx)(`div`,{className:`flex border-b border-yellow-400/10`,children:nl.map((t,n)=>(0,j.jsx)(`button`,{onClick:()=>s(n),className:`flex-1 py-4 px-4 text-center font-cinzel text-sm tracking-widest transition-all duration-300`,style:{letterSpacing:`0.15em`,color:e===n?`var(--gold-300)`:`var(--steel)`,background:e===n?`rgba(201,162,39,0.08)`:`transparent`,borderBottom:e===n?`2px solid var(--gold-300)`:`2px solid transparent`,borderRight:n<nl.length-1?`1px solid rgba(255,255,255,0.08)`:`none`},children:(0,j.jsx)(`span`,{className:`uppercase block`,style:{fontSize:`0.9rem`},children:t.name})},t.name))}),(0,j.jsxs)(`div`,{className:`relative h-48 md:h-64 overflow-hidden`,children:[(0,j.jsx)(`img`,{src:l.image,alt:l.name,className:`w-full h-full object-cover`,style:{filter:`brightness(0.9) saturate(0.9)`}}),(0,j.jsx)(`div`,{className:`absolute inset-0`,style:{background:`linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(10,14,26,0.95) 100%)`}}),(0,j.jsxs)(`div`,{className:`absolute bottom-0 left-0 right-0 p-6 md:p-8`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest block mb-2`,style:{color:`var(--gold-400)`,letterSpacing:`0.25em`},children:l.tier}),(0,j.jsx)(`h3`,{className:`font-cinzel font-bold text-white`,style:{fontSize:`clamp(1.6rem, 4vw, 3rem)`},children:l.name})]})]}),(0,j.jsx)(`div`,{className:`flex border-b border-yellow-400/10 mt-4`,children:[`Heroic`,`Mythic`].map(e=>(0,j.jsx)(`button`,{onClick:()=>c(e),className:`flex-1 py-3 text-center font-cinzel text-xs tracking-widest transition-all duration-300`,style:{letterSpacing:`0.2em`,color:n===e?`var(--gold-300)`:`var(--steel)`,background:n===e?`rgba(201,162,39,0.08)`:`transparent`,borderBottom:n===e?`2px solid var(--gold-300)`:`2px solid transparent`},children:e.toUpperCase()},e))}),(0,j.jsxs)(`div`,{className:`p-6 md:p-8`,children:[(0,j.jsxs)(`div`,{className:`mb-8`,children:[(0,j.jsxs)(`div`,{className:`flex justify-between items-center mb-3`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest`,style:{color:`var(--steel)`,letterSpacing:`0.15em`},children:`OVERALL PROGRESS`}),(0,j.jsxs)(`span`,{className:`font-cinzel font-bold text-sm`,style:{color:rl[n].text},children:[u,`/`,d,` BOSSES`]})]}),(0,j.jsx)(il,{killed:u,total:d,difficulty:n,animate:i})]}),(0,j.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-2 gap-4`,children:l.bosses.map((e,t)=>{let r=t<u;return(0,j.jsxs)(`div`,{className:`flex items-center gap-4 py-3 px-4 transition-all duration-300`,style:{background:r?`${rl[n].badge}`:`rgba(255,255,255,0.02)`,border:`1px solid ${r?`${rl[n].text}30`:`rgba(255,255,255,0.05)`}`},children:[(0,j.jsx)(`div`,{className:`w-6 h-6 flex items-center justify-center flex-shrink-0 font-cinzel font-bold text-xs`,style:{background:r?rl[n].bar:`rgba(255,255,255,0.05)`,color:r?`#fff`:`var(--steel)`,borderRadius:`50%`},children:r?`✓`:t+1}),(0,j.jsx)(`span`,{className:`font-cinzel text-sm flex-1`,style:{color:r?`#e8e8e8`:`var(--steel)`,textDecoration:`none`},children:e}),r&&(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-wider`,style:{color:rl[n].text,letterSpacing:`0.1em`,fontSize:`10px`},children:`DEFEATED`})]},t)})})]})]})]})]})}var ol={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},sl=_.createContext&&_.createContext(ol),cl=function(){return cl=Object.assign||function(e){for(var t,n=1,r=arguments.length;n<r;n++)for(var i in t=arguments[n],t)Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},cl.apply(this,arguments)},ll=function(e,t){var n={};for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.indexOf(r)<0&&(n[r]=e[r]);if(e!=null&&typeof Object.getOwnPropertySymbols==`function`)for(var i=0,r=Object.getOwnPropertySymbols(e);i<r.length;i++)t.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(e,r[i])&&(n[r[i]]=e[r[i]]);return n};function ul(e){return e&&e.map(function(e,t){return _.createElement(e.tag,cl({key:t},e.attr),ul(e.child))})}function dl(e){return function(t){return _.createElement(fl,cl({attr:cl({},e.attr)},t),ul(e.child))}}function fl(e){var t=function(t){var n=e.attr,r=e.size,i=e.title,a=ll(e,[`attr`,`size`,`title`]),o=r||t.size||`1em`,s;return t.className&&(s=t.className),e.className&&(s=(s?s+` `:``)+e.className),_.createElement(`svg`,cl({stroke:`currentColor`,fill:`currentColor`,strokeWidth:`0`},t.attr,n,a,{className:s,style:cl(cl({color:e.color||t.color},t.style),e.style),height:o,width:o,xmlns:`http://www.w3.org/2000/svg`}),i&&_.createElement(`title`,null,i),e.children)};return sl===void 0?t(ol):_.createElement(sl.Consumer,null,function(e){return t(e)})}function pl(e){return dl({tag:`svg`,attr:{viewBox:`0 0 512 512`},child:[{tag:`path`,attr:{d:`M256 32C174 69.06 121.38 86.46 32 96c0 77.59 5.27 133.36 25.29 184.51a348.86 348.86 0 0071.43 112.41c49.6 52.66 104.17 80.4 127.28 87.08 23.11-6.68 77.68-34.42 127.28-87.08a348.86 348.86 0 0071.43-112.41C474.73 229.36 480 173.59 480 96c-89.38-9.54-142-26.94-224-64z`}}]})(e)}function ml(e){return dl({tag:`svg`,attr:{viewBox:`0 0 512 512`},child:[{tag:`path`,attr:{d:`M196 16a30 30 0 0 0-30 30v120H46a30 30 0 0 0-30 30v120a30 30 0 0 0 30 30h120v120a30 30 0 0 0 30 30h120a30 30 0 0 0 30-30V346h120a30 30 0 0 0 30-30V196a30 30 0 0 0-30-30H346V46a30 30 0 0 0-30-30H196z`}}]})(e)}function hl(e){return dl({tag:`svg`,attr:{viewBox:`0 0 24 24`},child:[{tag:`path`,attr:{d:`M7.04813 13.4061L10.5831 16.9421L9.1703 18.3558L10.5849 19.7711L9.17064 21.1853L6.69614 18.71L3.86734 21.5388L2.45312 20.1246L5.28192 17.2958L2.80668 14.8213L4.22089 13.4071L5.63477 14.8202L7.04813 13.4061ZM2.99907 3L6.54506 3.00335L18.3624 14.8207L19.7772 13.4071L21.1915 14.8213L18.7166 17.2962L21.545 20.1246L20.1308 21.5388L17.3024 18.7104L14.8275 21.1853L13.4133 19.7711L14.8269 18.3562L3.00181 6.53118L2.99907 3ZM17.4563 3.0001L20.9991 3.00335L21.001 6.52648L16.9481 10.5781L13.4121 7.0431L17.4563 3.0001Z`}}]})(e)}var gl=[{name:`Revikkuh`,classColor:`#0070DE`,className:`Shaman`,spec:`Restoration`,role:`Healer`,realm:`stormrage`},{name:`Berbatea`,classColor:`#00FF96`,className:`Monk`,spec:`Brewmaster`,role:`Tank`,realm:`malganis`},{name:`Killed`,classColor:`#C41E3A`,className:`Death Knight`,spec:`Blood`,role:`Tank`,realm:`garrosh`},{name:`Imzeus`,classColor:`#C69B6D`,className:`Warrior`,spec:`Fury`,role:`DPS`,realm:`stormrage`},{name:`Kinnpi`,classColor:`#ffffff`,className:`Priest`,spec:`Discipline`,role:`Healer`,realm:`thrall`},{name:`Angelofares`,classColor:`#AAD372`,className:`Hunter`,spec:`Marksmanship`,role:`DPS`,realm:`illidan`},{name:`Pepperjacked`,classColor:`#3FC7EB`,className:`Mage`,spec:`Frost`,role:`DPS`,realm:`proudmoore`},{name:`Narfjones`,classColor:`#F48CBA`,className:`Paladin`,spec:`Retribution`,role:`DPS`,realm:`stormrage`},{name:`Morraice`,classColor:`#C41E3A`,className:`Death Knight`,spec:`Unholy`,role:`DPS`,realm:`thrall`},{name:`Xuelin`,classColor:`#A330C9`,className:`Demon Hunter`,spec:`Devourer`,role:`DPS`,realm:`illidan`},{name:`Fuzzyxo`,classColor:`#FF7C0A`,className:`Druid`,spec:`Restoration`,role:`Healer`,realm:`tichondrius`},{name:`Boxxed`,classColor:`#AAD372`,className:`Hunter`,spec:`Beast Mastery`,role:`DPS`,realm:`stormrage`},{name:`Hotdaug`,classColor:`#33937F`,className:`Evoker`,spec:`Augmentation`,role:`DPS`,realm:`stormrage`},{name:`Mutegen`,classColor:`#FFF468`,className:`Rogue`,spec:`Subtlety`,role:`DPS`,realm:`dalaran`},{name:`Terdfarmer`,classColor:`#ffffff`,className:`Priest`,spec:`Shadow`,role:`DPS`,realm:`zuljin`},{name:`Æsîr`,classColor:`#C41E3A`,className:`Death Knight`,spec:`Frost`,role:`DPS`,realm:`wyrmrest-accord`},{name:`Lailanna`,classColor:`#F48CBA`,className:`Paladin`,spec:`Retribution`,role:`DPS`,realm:`stormrage`},{name:`Siegez`,classColor:`#AAD372`,className:`Hunter`,spec:`Survival`,role:`DPS`,realm:`stormrage`},{name:`Velastaria`,classColor:`#3FC7EB`,className:`Mage`,spec:`Frost`,role:`DPS`,realm:`proudmoore`},{name:`Lathel`,classColor:`#3FC7EB`,className:`Mage`,spec:`Frost`,role:`DPS`,realm:`thrall`},{name:`Snippysnap`,classColor:`#33937F`,className:`Evoker`,spec:`Preservation`,role:`Healer`,realm:`malganis`},{name:`Yoloswagcrew`,classColor:`#F48CBA`,className:`Paladin`,spec:`Holy`,role:`Healer`,realm:`arthas`},{name:`Oriaris`,classColor:`#8788EE`,className:`Warlock`,spec:`Demonology`,role:`DPS`,realm:`thrall`},{name:`Fuzzybabe`,classColor:`#00FF96`,className:`Monk`,spec:`Windwalker`,role:`DPS`,realm:`tichondrius`},{name:`Alottalicki`,classColor:`#F48CBA`,className:`Paladin`,spec:`Retribution `,role:`DPS`,realm:`stormrage`}],_l={Tank:`#4aaae8`,Healer:`#6aad6a`,DPS:`#e84a4a`},vl={Tank:(0,j.jsx)(pl,{size:16}),Healer:(0,j.jsx)(ml,{size:16}),DPS:(0,j.jsx)(hl,{size:16})},yl=()=>{let e=(0,_.useRef)(null);return{ref:e,onMove:t=>{if(!e.current)return;let n=e.current.getBoundingClientRect(),r=t.clientX-n.left,i=t.clientY-n.top,a=(r/n.width-.5)*24,o=-(i/n.height-.5)*24;e.current.style.transform=`rotateX(${o}deg) rotateY(${a}deg) translateZ(0px)`,e.current.style.setProperty(`--mx`,`${r}px`),e.current.style.setProperty(`--my`,`${i}px`)},onLeave:()=>{e.current&&(e.current.style.transform=`rotateX(0deg) rotateY(0deg) translateZ(0px)`)}}};function bl({member:e}){let t=yl(),n=e.realm||`illidan`,r=e.name.toLowerCase().replace(/['\s]+/g,`-`).replace(/[^a-z0-9-]/g,``).replace(/-+/g,`-`).replace(/^-|-$/g,``);return(0,j.jsx)(`a`,{href:`https://worldofwarcraft.blizzard.com/en-us/character/us/${n}/${r}/`,target:`_blank`,rel:`noopener noreferrer`,className:`block roster-card-link`,style:{display:`block`,touchAction:`none`,perspective:`1400px`},children:(0,j.jsxs)(`div`,{ref:t.ref,onPointerMove:t.onMove,onPointerLeave:t.onLeave,className:`group roster-card relative overflow-hidden rounded-xl p-6`,style:{transformStyle:`preserve-3d`,transformOrigin:`center center`,willChange:`transform`,transform:`rotateX(0deg) rotateY(0deg) translateZ(0px) scale(var(--card-scale,1))`,transition:`transform 120ms cubic-bezier(0.22, 1, 0.36, 1), box-shadow 180ms ease-out`,background:`rgba(20, 36, 82, 0.72)`,border:`1px solid transparent`,backgroundImage:`
            linear-gradient(rgba(12, 14, 19, 0.72),rgba(16, 18, 22, 0.72)),
            linear-gradient(
              135deg,
              rgba(255,255,255,.15),
            ...
            0 25px 55px rgba(0, 0, 0, 0.45)`,"--mx":`50px`,"--my":`50px`},children:[(0,j.jsx)(`div`,{className:`absolute inset-0`,style:{transform:`translateZ(-10px)`,background:`#03091d`,filter:`brightness(.65)`,zIndex:0}}),(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none`,style:{background:`radial-gradient(circle at var(--mx) var(--my), ${e.classColor}45, transparent 55%)`,opacity:.85,zIndex:1}}),(0,j.jsx)(`div`,{className:`shine absolute inset-0 pointer-events-none`,style:{zIndex:2,opacity:.8,mixBlendMode:`screen`,borderRadius:`inherit`}}),(0,j.jsxs)(`div`,{className:`card-links absolute flex gap-3 items-center`,style:{zIndex:60,top:68,right:10},children:[(0,j.jsx)(`a`,{href:`https://raider.io/characters/us/${n}/${r}`,target:`_blank`,rel:`noopener noreferrer`,"aria-label":`${e.name} on raider.io`,children:(0,j.jsx)(`img`,{src:`https://cdn.raiderio.net/images/brand/Mark_2ColorWhite.png`,alt:`raider.io`,style:{width:22,height:22,display:`block`,transform:`translateZ(44px)`}})}),(0,j.jsx)(`a`,{href:`https://www.warcraftlogs.com/character/us/${n}/${r}`,target:`_blank`,rel:`noopener noreferrer`,"aria-label":`${e.name} on Warcraft Logs`,children:(0,j.jsx)(`img`,{src:`https://assets.rpglogs.com/img/warcraft/header-logo.png`,alt:`warcraftlogs`,style:{width:22,height:22,display:`block`,transform:`translateZ(44px)`}})})]}),(0,j.jsx)(`div`,{className:`absolute top-4 right-4 flex items-center justify-center`,style:{width:42,height:42,borderRadius:`50%`,transform:`translateZ(55px)`,background:`${_l[e.role]}18`,border:`1px solid ${_l[e.role]}66`,color:_l[e.role],boxShadow:`0 0 22px ${_l[e.role]}55`},children:vl[e.role]}),(0,j.jsx)(`div`,{className:`font-cinzel font-semibold text-xl mb-0.5`,style:{transform:`translateZ(34px)`},children:e.name}),(0,j.jsxs)(`div`,{className:`font-cinzel text-md`,style:{transform:`translateZ(22px)`,color:e.classColor,textShadow:`0 0 6px ${e.classColor}`},children:[e.spec,` `,e.className]})]})})}function xl(){let e=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.05});return e.current?.querySelectorAll(`.reveal`).forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsxs)(`section`,{id:`roster`,ref:e,className:`relative py-32 overflow-hidden`,style:{background:`linear-gradient(180deg, #06080f 0%, #0a0e1a 50%, #06080f 100%)`},children:[(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none opacity-20`,style:{backgroundImage:`radial-gradient(ellipse 40% 30% at 80% 50%, rgba(30,58,92,0.5) 0%, transparent 70%)`}}),(0,j.jsxs)(`div`,{className:`w-full max-w-screen-2xl mx-auto px-8 sm:px-10 lg:px-12 relative z-10`,children:[(0,j.jsxs)(`div`,{className:`reveal flex flex-col items-center text-center mb-16`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest mb-4`,style:{color:`var(--gold-400)`,letterSpacing:`0.3em`},children:`MEET THE TEAM`}),(0,j.jsx)(`h2`,{className:`font-cinzel font-bold text-gold-gradient mb-6`,style:{fontSize:`clamp(1.8rem, 4vw, 3rem)`},children:`The Roster`}),(0,j.jsx)(`div`,{className:`gold-separator`})]}),(0,j.jsx)(`div`,{className:`reveal grid grid-cols-3 gap-4 mb-12 max-w-lg mx-auto`,children:[`Tank`,`Healer`,`DPS`].map(e=>{let t=gl.filter(t=>t.role===e).length;return(0,j.jsxs)(`div`,{className:`flex flex-col items-center gap-2 py-4 px-3`,style:{background:`${_l[e]}10`,border:`1px solid ${_l[e]}30`},children:[(0,j.jsx)(`span`,{className:`text-xl`,children:vl[e]}),(0,j.jsx)(`span`,{className:`font-cinzel font-bold text-4xl`,style:{color:_l[e]},children:t}),(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest`,style:{color:`var(--steel)`,letterSpacing:`0.1em`,fontSize:`20px`},children:(e===`DPS`?`DPS`:`${e}s`).toUpperCase()})]},e)})}),(0,j.jsx)(`div`,{className:`reveal grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4`,children:gl.map((e,t)=>(0,j.jsx)(bl,{member:e,index:t},`${e.name}-${t}`))})]})]})}function Sl(e){return dl({tag:`svg`,attr:{viewBox:`0 0 640 512`},child:[{tag:`path`,attr:{d:`M524.531,69.836a1.5,1.5,0,0,0-.764-.7A485.065,485.065,0,0,0,404.081,32.03a1.816,1.816,0,0,0-1.923.91,337.461,337.461,0,0,0-14.9,30.6,447.848,447.848,0,0,0-134.426,0,309.541,309.541,0,0,0-15.135-30.6,1.89,1.89,0,0,0-1.924-.91A483.689,483.689,0,0,0,116.085,69.137a1.712,1.712,0,0,0-.788.676C39.068,183.651,18.186,294.69,28.43,404.354a2.016,2.016,0,0,0,.765,1.375A487.666,487.666,0,0,0,176.02,479.918a1.9,1.9,0,0,0,2.063-.676A348.2,348.2,0,0,0,208.12,430.4a1.86,1.86,0,0,0-1.019-2.588,321.173,321.173,0,0,1-45.868-21.853,1.885,1.885,0,0,1-.185-3.126c3.082-2.309,6.166-4.711,9.109-7.137a1.819,1.819,0,0,1,1.9-.256c96.229,43.917,200.41,43.917,295.5,0a1.812,1.812,0,0,1,1.924.233c2.944,2.426,6.027,4.851,9.132,7.16a1.884,1.884,0,0,1-.162,3.126,301.407,301.407,0,0,1-45.89,21.83,1.875,1.875,0,0,0-1,2.611,391.055,391.055,0,0,0,30.014,48.815,1.864,1.864,0,0,0,2.063.7A486.048,486.048,0,0,0,610.7,405.729a1.882,1.882,0,0,0,.765-1.352C623.729,277.594,590.933,167.465,524.531,69.836ZM222.491,337.58c-28.972,0-52.844-26.587-52.844-59.239S193.056,219.1,222.491,219.1c29.665,0,53.306,26.82,52.843,59.239C275.334,310.993,251.924,337.58,222.491,337.58Zm195.38,0c-28.971,0-52.843-26.587-52.843-59.239S388.437,219.1,417.871,219.1c29.667,0,53.307,26.82,52.844,59.239C470.715,310.993,447.538,337.58,417.871,337.58Z`}}]})(e)}function Cl(e){return dl({tag:`svg`,attr:{viewBox:`0 0 640 512`},child:[{tag:`path`,attr:{d:`M192 256c61.9 0 112-50.1 112-112S253.9 32 192 32 80 82.1 80 144s50.1 112 112 112zm76.8 32h-8.3c-20.8 10-43.9 16-68.5 16s-47.6-6-68.5-16h-8.3C51.6 288 0 339.6 0 403.2V432c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48v-28.8c0-63.6-51.6-115.2-115.2-115.2zM480 256c53 0 96-43 96-96s-43-96-96-96-96 43-96 96 43 96 96 96zm48 32h-3.8c-13.9 4.8-28.6 8-44.2 8s-30.3-3.2-44.2-8H432c-20.4 0-39.2 5.9-55.7 15.4 24.4 26.3 39.7 61.2 39.7 99.8v38.4c0 2.2-.5 4.3-.6 6.4H592c26.5 0 48-21.5 48-48 0-61.9-50.1-112-112-112z`}}]})(e)}var wl=[{class:`Warrior`,color:`#9D9D9D`,specs:[{spec:`Arms`,status:`limited`},{spec:`Fury`,status:`closed`},{spec:`Protection`,status:`closed`}]},{class:`Paladin`,color:`#F48CBA`,specs:[{spec:`Holy`,status:`open`},{spec:`Protection`,status:`closed`},{spec:`Retribution`,status:`limited`}]},{class:`Hunter`,color:`#AAD372`,specs:[{spec:`Beast Mastery`,status:`open`},{spec:`Marksmanship`,status:`closed`},{spec:`Survival`,status:`open`}]},{class:`Rogue`,color:`#FFF468`,specs:[{spec:`Assassination`,status:`open`},{spec:`Outlaw`,status:`open`},{spec:`Subtlety`,status:`open`}]},{class:`Priest`,color:`#FFFFFF`,specs:[{spec:`Discipline`,status:`open`},{spec:`Holy`,status:`limited`},{spec:`Shadow`,status:`limited`}]},{class:`Death Knight`,color:`#C41E3A`,specs:[{spec:`Blood`,status:`closed`},{spec:`Frost`,status:`open`},{spec:`Unholy`,status:`open`}]},{class:`Shaman`,color:`#0070DD`,specs:[{spec:`Elemental`,status:`open`},{spec:`Enhancement`,status:`limited`},{spec:`Restoration`,status:`closed`}]},{class:`Mage`,color:`#69CCF0`,specs:[{spec:`Arcane`,status:`open`},{spec:`Fire`,status:`open`},{spec:`Frost`,status:`limited`}]},{class:`Warlock`,color:`#8788EE`,specs:[{spec:`Affliction`,status:`open`},{spec:`Demonology`,status:`open`},{spec:`Destruction`,status:`open`}]},{class:`Monk`,color:`#00FF98`,specs:[{spec:`Brewmaster`,status:`closed`},{spec:`Mistweaver`,status:`open`},{spec:`Windwalker`,status:`limited`}]},{class:`Druid`,color:`#FF7C0A`,specs:[{spec:`Balance`,status:`open`},{spec:`Feral`,status:`limited`},{spec:`Guardian`,status:`closed`},{spec:`Restoration`,status:`open`}]},{class:`Evoker`,color:`#33937F`,specs:[{spec:`Devastation`,status:`open`},{spec:`Augmentation`,status:`limited`},{spec:`Preservation`,status:`open`}]}],Tl={open:{icon:(0,j.jsx)(b,{size:24}),label:`Open`,color:`#6aad6a`,bg:`rgba(106,173,106,0.12)`},limited:{icon:(0,j.jsx)(S,{size:24}),label:`Limited`,color:`#d4a44a`,bg:`rgba(212,164,74,0.12)`},closed:{icon:(0,j.jsx)(Cl,{size:24}),label:`Social`,color:`#2d88c5`,bg:`rgba(51,147,127,0.12)`}};function El(){let e=(0,_.useRef)(null),[t,n]=(0,_.useState)(!1),[r,i]=(0,_.useState)(null),[a,o]=(0,_.useState)({name:``,realm:``,server:``,contact:``,class:``,spec:``,message:``,experience:``});(0,_.useEffect)(()=>{let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.05});return e.current?.querySelectorAll(`.reveal`).forEach(e=>t.observe(e)),()=>t.disconnect()},[]);let s=async e=>{e.preventDefault(),i(null);let t=new FormData;t.append(`character`,a.name),t.append(`realm`,a.realm),t.append(`server`,a.server),t.append(`contact`,a.contact),t.append(`class`,a.class),t.append(`spec`,a.spec),t.append(`message`,a.message),t.append(`experience`,a.experience);try{let e=await fetch(`https://www.formdump.com/api/f/702cadf9-5e99-4544-aedc-3394ba5c52e4`,{method:`POST`,body:t});if(!e.ok)throw Error(`Formdump submit failed: ${e.status}`);n(!0)}catch(e){i(e instanceof Error?e.message:`Submit failed`),console.error(e)}},c=(e,t)=>{o(n=>({...n,[e]:t}))};return(0,j.jsxs)(`section`,{id:`recruitment`,ref:e,className:`relative py-32 overflow-hidden`,style:{background:`linear-gradient(180deg, #06080f 0%, #0a0e1a 50%, #06080f 100%)`},children:[(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none opacity-20`,style:{backgroundImage:`radial-gradient(ellipse 50% 40% at 30% 50%, rgba(201,162,39,0.06) 0%, transparent 70%)`}}),(0,j.jsxs)(`div`,{className:`w-full max-w-screen-2xl mx-auto px-8 sm:px-10 lg:px-12 relative z-10`,children:[(0,j.jsxs)(`div`,{className:`reveal flex flex-col items-center text-center mb-16`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest mb-4`,style:{color:`var(--gold-400)`,letterSpacing:`0.3em`},children:`LOOKING FOR MORE`}),(0,j.jsx)(`h2`,{className:`font-cinzel font-bold text-gold-gradient mb-6`,style:{fontSize:`clamp(1.8rem, 4vw, 3rem)`},children:`Recruitment`}),(0,j.jsx)(`div`,{className:`gold-separator mb-6`}),(0,j.jsxs)(`p`,{className:`max-w-full text-lg leading-relaxed`,style:{color:`var(--steel-light)`,lineHeight:`1.8`},children:[`We're always looking for exceptional players to strengthen our raid roster. Check your class and spec below, then apply.`,(0,j.jsx)(`br`,{}),(0,j.jsx)(`br`,{}),`If you are a casual player looking for a new home, we also welcome social members to join our community!`]})]}),(0,j.jsx)(`div`,{className:`reveal flex items-center justify-center gap-6 mb-10 flex-wrap`,children:[`open`,`limited`,`closed`].map(e=>(0,j.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,j.jsx)(`span`,{style:{color:Tl[e].color},children:Tl[e].icon}),(0,j.jsx)(`span`,{className:`font-cinzel text-lg tracking-widest`,style:{color:`var(--steel)`,letterSpacing:`0.15em`},children:Tl[e].label.toUpperCase()})]},e))}),(0,j.jsx)(`div`,{className:`reveal grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-20`,children:wl.map(e=>(0,j.jsxs)(`div`,{className:`relative group overflow-hidden rounded-xl p-5 transition-all duration-300 hover:-translate-y-0.5`,style:{transformStyle:`preserve-3d`,background:`rgba(20, 36, 82, 0.72)`,border:`1px solid transparent`,backgroundImage:`
                  linear-gradient(rgba(12, 14, 19, 0.72), rgba(16, 18, 22, 0.72)),
                  linear-gradient(
                    135deg,
                    rgba(255,255,255,.12),
                    ...
                    transparent 68%,
                    rgba(255,255,255,.12)
                  )`,backgroundOrigin:`border-box`,backgroundClip:`padding-box,border-box`,boxShadow:`inset 0 1px rgba(255,255,255,.08), inset 0 -10px 25px rgba(0,0,0,0.5), 0 25px 55px rgba(0,0,0,0.45)`},children:[(0,j.jsx)(`div`,{className:`absolute inset-0`,style:{transform:`translateZ(-10px)`,background:`#03091d`,filter:`brightness(.65)`,zIndex:0}}),(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none`,style:{background:`radial-gradient(circle at 20% 20%, rgba(255,255,255,0.08), transparent 52%)`,opacity:.7,zIndex:1}}),(0,j.jsx)(`div`,{className:`shine absolute inset-0 pointer-events-none`,style:{zIndex:2,opacity:.7,mixBlendMode:`screen`,borderRadius:`inherit`}}),(0,j.jsxs)(`div`,{className:`relative z-10`,children:[(0,j.jsx)(`div`,{className:`font-cinzel font-semibold text-sm mb-4 pb-3`,style:{color:e.color,borderBottom:`1px solid ${e.color}20`,letterSpacing:`0.05em`},children:e.class}),(0,j.jsx)(`div`,{className:`flex flex-col gap-2`,children:e.specs.map(({spec:e,status:t})=>{let n=Tl[t];return(0,j.jsxs)(`div`,{className:`flex items-center justify-between px-3 py-2`,style:{background:n.bg,border:`1px solid ${n.color}20`},children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs`,style:{color:t===`closed`?`var(--steel)`:`#d8d8d8`},children:e}),(0,j.jsxs)(`div`,{className:`flex items-center gap-1`,style:{color:n.color},children:[n.icon,(0,j.jsx)(`span`,{className:`font-cinzel text-xs`,style:{fontSize:`10px`,letterSpacing:`0.1em`},children:n.label.toUpperCase()})]})]},e)})})]})]},e.class))}),(0,j.jsx)(`div`,{className:`reveal max-w-4xl mx-auto p-8 md:p-12`,style:{background:`rgba(10,14,26,0.8)`,border:`1px solid rgba(201,162,39,0.15)`},children:t?(0,j.jsxs)(`div`,{className:`flex flex-col items-center text-center py-8`,children:[(0,j.jsx)(`div`,{className:`w-16 h-16 flex items-center justify-center mb-6`,style:{background:`rgba(106,173,106,0.1)`,border:`1px solid rgba(106,173,106,0.3)`,color:`#6aad6a`},children:(0,j.jsx)(b,{size:32})}),(0,j.jsx)(`h3`,{className:`font-cinzel font-bold text-xl mb-3 text-gold-gradient`,children:`Application Received`}),(0,j.jsx)(`p`,{className:`text-sm`,style:{color:`var(--steel-light)`,lineHeight:`1.7`},children:`Your application has been submitted. Our officers will review it within 48 hours and reach out via Battle.net or Discord.`})]}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`div`,{className:`text-center mb-8`,children:(0,j.jsx)(`h3`,{className:`font-cinzel font-bold text-xl mb-2`,style:{color:`#e8e8e8`},children:`Apply to the Guild`})}),(0,j.jsxs)(`form`,{onSubmit:s,className:`flex flex-col gap-5`,children:[(0,j.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-5`,children:[{field:`name`,label:`Character Name`,placeholder:`Revika`},{field:`realm`,label:`Realm`,placeholder:`Stormrage`},{field:`server`,label:`Server`,placeholder:`US`},{field:`contact`,label:`Battle.net/Discord`,placeholder:`Revika#1234/revika`}].map(({field:e,label:t,placeholder:n})=>(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`label`,{className:`block font-cinzel text-xs tracking-widest mb-2`,style:{color:`var(--steel-light)`,letterSpacing:`0.15em`},children:t.toUpperCase()}),(0,j.jsx)(`input`,{type:`text`,placeholder:n,value:a[e],onChange:t=>c(e,t.target.value),required:!0,className:`w-full px-4 py-3 text-sm font-cinzel outline-none transition-all duration-200`,style:{background:`rgba(255,255,255,0.03)`,border:`1px solid rgba(201,162,39,0.2)`,color:`#e8e8e8`,letterSpacing:`0.05em`},onFocus:e=>e.target.style.borderColor=`rgba(201,162,39,0.5)`,onBlur:e=>e.target.style.borderColor=`rgba(201,162,39,0.2)`})]},e))}),(0,j.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-5`,children:[{field:`class`,label:`Class`,placeholder:`Mage`},{field:`spec`,label:`Spec`,placeholder:`Frost`}].map(({field:e,label:t,placeholder:n})=>(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`label`,{className:`block font-cinzel text-xs tracking-widest mb-2`,style:{color:`var(--steel-light)`,letterSpacing:`0.15em`},children:t.toUpperCase()}),(0,j.jsx)(`input`,{type:`text`,placeholder:n,value:a[e],onChange:t=>c(e,t.target.value),required:!0,className:`w-full px-4 py-3 text-sm font-cinzel outline-none transition-all duration-200`,style:{background:`rgba(255,255,255,0.03)`,border:`1px solid rgba(201,162,39,0.2)`,color:`#e8e8e8`,letterSpacing:`0.05em`},onFocus:e=>e.target.style.borderColor=`rgba(201,162,39,0.5)`,onBlur:e=>e.target.style.borderColor=`rgba(201,162,39,0.2)`})]},e))}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`label`,{className:`block font-cinzel text-xs tracking-widest mb-2`,style:{color:`var(--steel-light)`,letterSpacing:`0.15em`},children:`MYTHIC EXPERIENCE`}),(0,j.jsx)(`input`,{type:`text`,placeholder:`e.g. 8/8 Manaforge Omega CE, 6/10 Midnight`,value:a.experience,onChange:e=>c(`experience`,e.target.value),className:`w-full px-4 py-3 text-sm font-cinzel outline-none transition-all duration-200`,style:{background:`rgba(255,255,255,0.03)`,border:`1px solid rgba(201,162,39,0.2)`,color:`#e8e8e8`,letterSpacing:`0.05em`},onFocus:e=>e.target.style.borderColor=`rgba(201,162,39,0.5)`,onBlur:e=>e.target.style.borderColor=`rgba(201,162,39,0.2)`})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`label`,{className:`block font-cinzel text-xs tracking-widest mb-2`,style:{color:`var(--steel-light)`,letterSpacing:`0.15em`},children:`TELL US ABOUT YOURSELF`}),(0,j.jsx)(`textarea`,{rows:4,placeholder:`Why do you want to join Ride On Time? What makes you stand out?`,value:a.message,onChange:e=>c(`message`,e.target.value),className:`w-full px-4 py-3 text-sm font-cinzel outline-none transition-all duration-200 resize-none`,style:{background:`rgba(255,255,255,0.03)`,border:`1px solid rgba(201,162,39,0.2)`,color:`#e8e8e8`,letterSpacing:`0.05em`,lineHeight:`1.6`},onFocus:e=>e.target.style.borderColor=`rgba(201,162,39,0.5)`,onBlur:e=>e.target.style.borderColor=`rgba(201,162,39,0.2)`})]}),(0,j.jsxs)(`button`,{type:`submit`,className:`w-full py-4 font-cinzel text-sm tracking-widest relative overflow-hidden group mt-2`,style:{letterSpacing:`0.2em`,background:`linear-gradient(135deg, rgba(201,162,39,0.2), rgba(201,162,39,0.08))`,border:`1px solid rgba(201,162,39,0.5)`,color:`#e8c84a`},children:[(0,j.jsx)(`span`,{className:`relative z-10`,children:`SUBMIT APPLICATION`}),(0,j.jsx)(`div`,{className:`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300`,style:{background:`linear-gradient(135deg, rgba(201,162,39,0.3), rgba(201,162,39,0.15))`}})]}),r&&(0,j.jsx)(`div`,{className:`text-sm text-center text-red-300 mt-3`,style:{color:`#f29b9b`},children:r})]})]})})]})]})}function Dl(e){return dl({tag:`svg`,attr:{role:`img`,viewBox:`0 0 24 24`},child:[{tag:`title`,attr:{},child:[]},{tag:`path`,attr:{d:`M20.001 3.106c0-.059 0-.187.063-.187.09 0 .167.19.196.27.486 1.548.35 3.449-.345 5.588 2.756 1.473 4.338 3.382 4.052 5.168-.38 2.347-3.824 3.727-8.462 3.565a27.12 27.12 0 001.55-1.825c1.786-.347 3.066-1.053 3.4-2.184.246-.823-.32-1.736-1.396-2.594-1.768 3.723-4.722 7.058-7.451 8.985 1.323 1.687 2.556 2.858 3.964 3.516.052.025.164.09.126.148-.044.078-.252.05-.33.034-1.585-.352-3.158-1.42-4.673-3.093-2.652 1.65-5.099 2.066-6.502.925-1.842-1.5-1.316-5.178 1.137-9.106.193.631.505 1.526.806 2.253-.594 1.721-.622 3.183.19 4.041.59.623 1.664.59 2.945.088-2.325-3.395-3.738-7.62-4.04-10.954-2.124.303-3.754.785-5.027 1.675-.048.033-.16.098-.195.04-.044-.078.082-.24.137-.304 1.098-1.196 2.812-2.028 5.012-2.496-.102-3.124.758-5.45 2.45-6.093 2.22-.846 5.14 1.448 7.316 5.542a26.617 26.617 0 00-2.354-.429c-1.193-1.372-2.446-2.13-3.594-1.854-.834.2-1.341 1.146-1.547 2.502 4.108-.332 8.473.56 11.51 1.964.8-1.984 1.197-3.637 1.062-5.185zm-9.598 15.057c3.252-1.859 5.889-4.696 7.638-7.965-3.24-1.88-7.013-2.75-10.716-2.627-.008 3.745 1.124 7.451 3.082 10.594Z`}}]})(e)}var Ol=[{name:`REVIKA`,battleTag:`Revika#1234`,discord:`Revika#1234`},{name:`KIL`,battleTag:`Lychenz#1926`,discord:`lychenz`},{name:`ZEUS`,battleTag:`Zeus#9101`,discord:`Zeus#9101`},{name:`KINN`,battleTag:`kinetix#11410`,discord:`kinetixxx`},{name:`ANGEL`,battleTag:`AngelOfAres#1382`,discord:`angel_of_ares`},{name:`BERBALERB`,battleTag:`Berbalerb#8642`,discord:`Berbalerb#8642`},{name:`HITTA`,battleTag:`Hitta#1122`,discord:`Hitta#1122`},{name:`BOOJIE`,battleTag:`Boojie#3344`,discord:`Boojie#3344`}],kl=`#ffd969`,Al=`#d1a94b`,jl=`#d19e38`,Ml=`#b1812a`,Nl=`#553d13`,Pl=`#0d1730`,Fl=`#16234a`,Il=`#24356b`,Ll=`#f7ecd3`;function Rl({children:e}){return(0,j.jsx)(`div`,{className:`flex h-7 w-7 shrink-0 items-center justify-center rounded-full`,style:{background:`linear-gradient(155deg, ${kl}, ${jl})`,boxShadow:`inset 0 1px rgba(255,255,255,0.5), 0 1px 3px rgba(0,0,0,0.4)`},children:e})}function zl({icon:e,value:t}){return(0,j.jsx)(`div`,{className:`relative overflow-hidden rounded-2xl px-4 py-3`,style:{background:`linear-gradient(155deg, ${Fl}, ${Pl})`,border:`1px solid ${Ml}66`,boxShadow:`inset 0 1px rgba(255,255,255,0.06), inset 0 -6px 14px rgba(0,0,0,0.4)`},children:(0,j.jsxs)(`div`,{className:`flex items-center gap-2.5`,children:[(0,j.jsx)(Rl,{children:e}),(0,j.jsx)(`div`,{className:`mt-0.5 truncate text-lg font-medium`,style:{color:Ll},children:t})]})})}function Bl({officer:e}){let t=(0,_.useRef)(null),[n,r]=(0,_.useState)({}),[i,a]=(0,_.useState)({x:50,y:50,active:!1});return(0,j.jsx)(`div`,{style:{perspective:`900px`},className:`reveal hover-card-wrapper`,children:(0,j.jsxs)(`div`,{ref:t,onMouseMove:e=>{let n=t.current;if(!n)return;let i=n.getBoundingClientRect(),o=(e.clientX-i.left)/i.width,s=(e.clientY-i.top)/i.height,c=(o-.5)*8*2,l=-(s-.5)*8*2;r({transform:`perspective(900px) rotateX(${l}deg) rotateY(${c}deg) translateZ(10px)`}),a({x:o*100,y:s*100,active:!0})},onMouseLeave:()=>{r({transform:`perspective(900px) rotateX(0deg) rotateY(0deg) translateZ(0px)`}),a(e=>({...e,active:!1}))},className:`group relative overflow-hidden rounded-[34px] p-6 transition-all duration-300`,style:{background:`linear-gradient(155deg, ${kl} 0%, ${Al} 32%, ${jl} 68%, ${Ml} 100%)`,border:`1px solid ${Nl}`,boxShadow:i.active?`inset 0 1px rgba(255,255,255,0.65), inset 0 -14px 26px rgba(90,58,10,0.45), 0 24px 56px rgba(0,0,0,0.4)`:`inset 0 1px rgba(255,255,255,0.5), inset 0 -10px 22px rgba(90,58,10,0.35), 0 12px 28px rgba(0,0,0,0.3)`,transformStyle:`preserve-3d`,transition:`transform 150ms cubic-bezier(0.22, 1, 0.36, 1), box-shadow 180ms ease-out`,...n},children:[(0,j.jsx)(`div`,{className:`pointer-events-none absolute inset-0 transition-opacity duration-300`,style:{opacity:+!!i.active,background:`radial-gradient(circle 140px at ${i.x}% ${i.y}%, rgba(255,255,255,0.45), transparent 70%)`,mixBlendMode:`overlay`}}),(0,j.jsx)(`div`,{className:`pointer-events-none absolute inset-0 shine`,style:{background:`linear-gradient(135deg, rgba(255,255,255,0.25), transparent 45%, rgba(120,84,20,0.15) 75%)`,opacity:.6}}),(0,j.jsxs)(`div`,{style:{transform:`translateZ(28px)`,transformStyle:`preserve-3d`},children:[(0,j.jsx)(`div`,{className:`mb-5 flex items-center justify-center`,children:(0,j.jsx)(`div`,{className:`font-cinzel font-semibold text-3xl tracking-wide w-full text-center`,style:{color:Pl,textShadow:`0 1px 0 rgba(255,255,255,0.3)`},children:e.name})}),(0,j.jsxs)(`div`,{className:`grid grid-cols-1 gap-3 text-sm`,children:[(0,j.jsx)(zl,{icon:(0,j.jsx)(Dl,{color:Pl}),value:e.battleTag}),(0,j.jsx)(zl,{icon:(0,j.jsx)(Sl,{color:Pl}),value:e.discord})]})]}),(0,j.jsx)(`div`,{className:`pointer-events-none absolute bottom-6 left-6 right-6 h-px opacity-70`,style:{background:`linear-gradient(90deg, transparent, ${Il}, transparent)`}})]})})}function Vl(){let e=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.12});return e.current?.querySelectorAll(`.reveal`).forEach(e=>t.observe(e)),()=>t.disconnect()},[]),(0,j.jsx)(`section`,{id:`contact`,ref:e,className:`relative py-24 overflow-hidden`,style:{background:`linear-gradient(180deg, #06080f 0%, #0a0e1a 100%)`},children:(0,j.jsxs)(`div`,{className:`w-full max-w-screen-2xl mx-auto px-8 sm:px-10 lg:px-12 relative z-10`,children:[(0,j.jsxs)(`div`,{className:`text-center mb-12 reveal`,children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest mb-4 inline-block`,style:{color:Al,letterSpacing:`0.3em`},children:`CONTACT US`}),(0,j.jsx)(`h2`,{className:`font-cinzel font-bold text-gold-gradient`,style:{fontSize:`clamp(1.8rem, 4vw, 3rem)`},children:`Officer Contacts`}),(0,j.jsx)(`p`,{className:`mt-4 text-lg max-w-full mx-auto`,style:{color:`#9aa4bd`,lineHeight:`1.8`},children:`Reach out to any of our officers via Battle.net or Discord for recruitment questions, raid support, or guild information.`})]}),(0,j.jsx)(`div`,{className:`reveal grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6`,children:Ol.map(e=>(0,j.jsx)(Bl,{officer:e},e.name))})]})})}function Hl(){let e=new Date().getFullYear(),t=e=>{let t=e.slice(1),n=document.getElementById(t);if(!n)return;let r=document.querySelector(`nav`)?.clientHeight??160,i=n.getBoundingClientRect().top+window.pageYOffset-r-10;window.scrollTo({top:Math.max(i,0),behavior:`smooth`})};return(0,j.jsxs)(`footer`,{className:`relative pb-16 pt-4 overflow-hidden`,style:{background:`linear-gradient(180deg, #06080f 0%, #030408 100%)`,borderTop:`1px solid rgba(201,162,39,0.1)`},children:[(0,j.jsx)(`div`,{className:`absolute inset-0 pointer-events-none`,style:{background:`radial-gradient(ellipse 60% 40% at 50% 0%, rgba(201,162,39,0.04) 0%, transparent 70%)`}}),(0,j.jsx)(`div`,{className:`w-full max-w-screen-2xl mx-auto px-8 sm:px-10 lg:px-12 relative z-10`,children:(0,j.jsxs)(`div`,{className:`flex flex-col items-center text-center gap-6`,children:[(0,j.jsx)(`button`,{onClick:()=>t(`#home`),className:`flex items-center gap-3 group`,children:(0,j.jsx)(`img`,{src:`logo.png`,alt:`Ride On Time`,className:`h-36 w-36 object-contain transition-all duration-300 group-hover:scale-110`,style:{filter:`drop-shadow(0 0 2px rgba(201,162,39,0.5))`,marginBottom:`-1.2rem`}})}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`div`,{className:`font-cinzel-decorative font-bold text-gold-gradient mb-1`,style:{fontSize:`2rem`},children:`Ride On Time`}),(0,j.jsx)(`div`,{className:`font-cinzel text-md tracking-widest mb-1`,style:{color:`var(--steel)`,letterSpacing:`0.25em`},children:`MYTHIC RAID GUILD`}),(0,j.jsx)(`div`,{className:`font-cinzel text-xs tracking-widest`,style:{color:`var(--steel)`,letterSpacing:`0.25em`},children:`STORMRAGE \xA0•\xA0 US`})]}),(0,j.jsx)(`div`,{className:`gold-separator-full max-w-xs`}),(0,j.jsx)(`nav`,{className:`flex items-center gap-6 flex-wrap justify-center`,children:[{label:`Home`,href:`#home`},{label:`About`,href:`#about`},{label:`Progression`,href:`#progression`},{label:`Roster`,href:`#roster`},{label:`Recruitment`,href:`#recruitment`}].map(e=>(0,j.jsx)(`a`,{href:e.href,onClick:n=>{n.preventDefault(),t(e.href)},className:`font-cinzel text-xs tracking-widest transition-colors duration-200 hover:text-yellow-300`,style:{color:`var(--steel)`,letterSpacing:`0.15em`},children:e.label.toUpperCase()},e.href))}),(0,j.jsxs)(`div`,{className:`flex items-center gap-2 px-6 py-3`,style:{background:`rgba(201,162,39,0.05)`,border:`1px solid rgba(201,162,39,0.12)`},children:[(0,j.jsx)(`span`,{className:`font-cinzel text-xs tracking-widest`,style:{color:`var(--gold-400)`,letterSpacing:`0.15em`},children:`RAID DAYS`}),(0,j.jsx)(`span`,{className:`w-px h-3 mx-2`,style:{background:`rgba(201,162,39,0.3)`}}),(0,j.jsx)(`span`,{className:`font-cinzel text-xs`,style:{color:`var(--steel-light)`,letterSpacing:`0.05em`},children:`Thursday \xA0•\xA0 Friday`}),(0,j.jsx)(`span`,{className:`w-px h-3 mx-2`,style:{background:`rgba(201,162,39,0.3)`}}),(0,j.jsx)(`span`,{className:`font-cinzel text-xs`,style:{color:`var(--steel)`,letterSpacing:`0.05em`},children:`9 PM – Midnight PM EST`})]}),(0,j.jsxs)(`p`,{className:`font-cinzel text-xs`,style:{color:`rgba(136,153,170,0.4)`,letterSpacing:`0.1em`,fontSize:`11px`},children:[`© `,e,` RIDE ON TIME — WORLD OF WARCRAFT GUILD. NOT AFFILIATED WITH BLIZZARD ENTERTAINMENT.`]})]})})]})}function Ul(){return(0,j.jsxs)(`div`,{className:`min-h-screen`,children:[(0,j.jsx)(N,{}),(0,j.jsxs)(`main`,{children:[(0,j.jsx)(Zc,{}),(0,j.jsx)(tl,{}),(0,j.jsx)(al,{}),(0,j.jsx)(xl,{}),(0,j.jsx)(El,{}),(0,j.jsx)(Vl,{})]}),(0,j.jsx)(Hl,{})]})}(0,ee.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(_.StrictMode,{children:(0,j.jsx)(Ul,{})}));